        ...
        <div className="relative mt-12">
          ...
          <div className="relative grid gap-8 lg:grid-cols-4">
            {steps.map((stepItem, index) => (
              ...
              >
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-br from-[#0F4C81] to-[#2B7CB3] text-lg font-semibold text-white shadow-lg">
                  {index + 1}
                </div>
