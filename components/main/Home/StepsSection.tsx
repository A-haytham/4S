    ...
    <section className="bg-linear-to-br from-gray-50 to-white py-20">
      <div className="mx-auto w-full max-w-6xl px-4 text-center">
        ...
        <div className="relative mt-12">
          <div className="absolute left-0 right-0 top-1/2 hidden h-1 -translate-y-1/2 bg-linear-to-br from-[#0F4C81] via-[#2B7CB3] to-[#E67E22] lg:block" />
          <div className="relative grid gap-8 lg:grid-cols-4">
            {steps.map((stepItem, index) => (
              ...
              >
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-brr from-[#0F4C81] to-[#2B7CB3] text-lg font-semibold text-white shadow-lg">
                  {index + 1}
                </div>
